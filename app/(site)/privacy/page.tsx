  ...
  return (
    <section className="flex flex-col flex-1 px-[22px] py-[26px] text-sm leading-relaxed">
      ...
      <ul className="list-disc pl-5 space-y-1">
        ...
        <li>신고 접수 및 부적절한 게시물 모니터링·제재를 위한 서비스 운영자의 열람</li>
      ...
      <p className="mt-2">
        답변 내용은 질문지를 만든 이용자(질문자)에게 전달되며, 신고 접수·분쟁
        처리 및 부적절한 게시물(욕설, 명예훼손, 성적 수치심을 유발하는 내용 등)
        모니터링을 위해 서비스 운영자(관리자)도 답변 내용을 열람할 수 있습니다.
        관리자의 조치(숨김·삭제 등)는 모두 별도의 관리자 활동 로그로 기록됩니다.
      </p>
